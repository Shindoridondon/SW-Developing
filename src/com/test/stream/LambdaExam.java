...
public class LambdaExam {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("람다식을 이용한 익명함수 : 2개의 인자를 받아서 메소드로 계산 후 반환하는 예 : " + lambdaFunction.sum(3, 5));
        ...
        //Supplier : 매개변수 없이 값만 변환하는 함수형 인터페이스
        Supplier<String> supplier = () -> "안녕하세요???";
        System.out.println("Supplier : 매개변수 없이 값만 변환하는 함수형 인터페이스 사용 예 : " + supplier.get());
        ...
        //Function : 객체 T를 매개 변수로 받아서 처리한 후, R로 반환하는 함수형 인터페이스
        Function<String,Integer> function = (str) -> str.length();
        System.out.println("Function : 객체 T를 매개 변수로 받아서 처리한 후, R로 반환하는 함수형 인터페이스 사용 예 : " + function.apply("값 입력")); 

        //Predicate : 객체 T를 매개변수로 받아 처리한 후 Boolean을 반환
        Predicate<String> predicate = (str) -> str.equals("Hello");
        System.out.println("Predicate : 객체 T를 매개변수로 받아 처리한 후 Boolean을 반환하는 예 : " + predicate.test("Hel"));
